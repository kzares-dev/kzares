...
export default function Navbar({
	...
	return (
		<div>
			<div className=" text-gray-300 w-4xl mx-auto border-x-2 border-t-2 border-slate-800 rounded-t-md bg-slate-800 p-2 flex items-center">
				...
				<div className="flex-1 mr-16 flex justify-center items-center">
					<div className="flex items-center gap-1">
						...
						<h1 className="text-center">kzares/portfolio</h1>
					</div>
				</div>
			</div>
		</div>
